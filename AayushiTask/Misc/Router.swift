...
class Router<ViewController> where ViewController: UIViewController {
...
extension UIViewController {
    ...
    func presentWireframe<ViewController>(_ wireframe: Router<ViewController>, animated: Bool = true, completion: (() -> Void)? = nil) {
...
extension UINavigationController {
    ...
    func pushWireframe<ViewController>(_ wireframe: Router<ViewController>, animated: Bool = true) {
        pushViewController(wireframe.viewController, animated: animated)
    }

    func setRootWireframe<ViewController>(_ wireframe: Router<ViewController>, animated: Bool = true) {
